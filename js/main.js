...
const AUDIO_DETAIL = [
	...
	{ 
		time: 14000, 
		count: 2, 
		startTimes: [ 1100, 8700 ], 
		dialog: { 
			Japanese: [
				"私はいつものジョギングのかわりに、ひと泳ぎしようと思いまして。",
				"せっかくの海ですから、普段とは違う事をすることを悪くないかな…っと。"
			],
			English: [
	...
	{ 
		time: 17000, 
		count: 2, 
		startTimes: [ 500, 11000 ], 
		dialog: { 
			Japanese: [
				"…そうですね。うさぎは水に入ってはいけないと言われていますが…",
				"私は、うさぎではありませんので。"
			],
			English: [
				"You have a point.",
...
const HITBOX = {
	headpat: { xMin: 1200, xMax: 1650, yMin: 0, yMax: 350 },
	voiceline: { xMin: 1200, xMax: 1690, yMin: 770, yMax: 1600 }
};
